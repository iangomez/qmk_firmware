...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LSFT,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,       KC_TILD,                    KC_GRV,         KC_N,           KC_M,           KC_COMM,        KC_DOT,         KC_SLASH,       KC_RALT,   
    _______,        _______,        _______,        _______,        _______,        KC_SPACE,   KC_LSFT,                    KC_BSPC,        KC_ENTER,       _______,        _______,        _______,        _______,        _______,   
                                                                    KC_LCTL,        _______,    _______,                    _______,        _______,        KC_LGUI                                                                  
    ),

    [_ARROWS] = LAYOUT_7x5(
    _______,        _______,        _______,        _______,        QK_REBOOT,      QK_BOOT,    _______,                    _______,        _______,        _______,        _______,        _______,        _______,        _______,       
    _______,        _______,        _______,        KC_ESC,         _______,        _______,    _______,                    _______,        _______,        KC_HOME,        KC_UP,          KC_END,         _______,        _______,               
    _______,        _______,        _______,        KC_LSFT,        KC_LCTL,        KC_DEL,     _______,                    _______,        _______,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       _______,        _______,               
    ...
    [_NUMPAD] = LAYOUT_7x5(
    _______,        _______,        _______,        _______,        _______,        _______,    _______,                    _______,        _______,        _______,        _______,        _______,        _______,        _______,     
    _______,        _______,        _______,        _______,        _______,        _______,    _______,                    _______,        _______,        KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_NO,          _______,       
    _______,        _______,        _______,        _______,        _______,        _______,    _______,                    _______,        KC_KP_0,        KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_NO,          _______,     
    _______,        _______,        _______,        _______,        _______,        _______,    _______,                    _______,        KC_DOT,         KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_NO,          _______,            
    _______,        _______,        _______,        _______,        _______,        _______,    _______,                    _______,        _______,        _______,        _______,        _______,        _______,        _______,   
                                                                    _______,        _______,    _______,                    _______,        _______,        _______                                                                  
    ),
    ...
    [_SYMBOLS] = LAYOUT_7x5(
    _______,        _______,        _______,        _______,        _______,        _______,    _______,                    _______,        _______,        _______,        _______,        _______,        _______,        _______,     
    _______,        KC_EXLM,        KC_AT,          KC_HASH,        KC_DLR,         KC_PERC,    _______,                    _______,        KC_TILD,        KC_LCBR,        KC_RCBR,        _______,        _______,        _______,       
    _______,        KC_CIRC,        KC_AMPR,        KC_ASTR,        _______,        _______,    _______,                    _______,        KC_GRV,         KC_LPRN,        KC_RPRN,        KC_UNDS,        _______,        _______,     
    ...
    _______,        _______,        _______,        _______,        _______,        _______,    _______,                    _______,        _______,        _______,        _______,        _______,        _______,        _______,       
    KC_LCTL,        KC_A,           KC_S,           KC_D,           KC_F,           _______,    _______,                    _______,        _______,        _______,        _______,        _______,        KC_SCLN,        _______,     
